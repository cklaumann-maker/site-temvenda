...
<?php wp_head(); ?>
<style>
  html,body{background:#000;color:#fff;font-family:Montserrat,system-ui,-apple-system,Segoe UI,Roboto,Arial}
</style>
</head>
<body <?php body_class('bg-black text-white antialiased'); ?>>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 grid md:grid-cols-2 gap-10 items-center">
      ...
      <div class="relative">
        ...
        <div class="relative bg-[#0b0b0b] border border-white/10 rounded-3xl p-6 md:p-10 shadow-2xl">
          ...
          <a href="#diagnostico" class="mt-6 inline-block rounded-2xl px-4 py-2 bg-[#5ee100] text-black font-semibold">
            Agendar diagnóstico
          </a>
        </div>
      </div>
  ...
  <!-- PROBLEMA -->
  <section class="py-16 md:py-24 border-t border-white/10 bg-[#0b0b0b]">
  ...
  <footer id="contato" class="border-t border-white/10 bg-black">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 grid md:grid-cols-3 gap-8">
      ...
      <div>
        ...
        <ul class="space-y-2 text-white/70 text-sm">
          <li>WhatsApp: (48) 9 9999-9999</li>
          <li>E-mail: contato@temvenda.com.br</li>
          <li>Cidade/UF</li>
        </ul>
        <a id="whats" href="#" class="mt-4 inline-block rounded-2xl px-4 py-2 bg-[#5ee100] text-black font-semibold">
          Chamar no Whats
        </a>
      </div>
    </div>
