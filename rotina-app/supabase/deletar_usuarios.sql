...
BEGIN
  ...
  LOOP
    ...
    IF deleted_count > 0 THEN
      RAISE NOTICE '  Deletados % resumos de calorias para usuário %', deleted_count, current_user_id;
    END IF;
  END LOOP;
  ...
  LOOP
    ...
    GET DIAGNOSTICS deleted_count = ROW_COUNT;
    IF deleted_count > 0 THEN
      RAISE NOTICE '  Deletadas % refeições para usuário %', deleted_count, current_user_id;
    END IF;
  END LOOP;
  ...
  LOOP
    ...
    GET DIAGNOSTICS deleted_count = ROW_COUNT;
    IF deleted_count > 0 THEN
      RAISE NOTICE '  Deletados % check-ins para usuário %', deleted_count, current_user_id;
    END IF;
  END LOOP;
  ...
  LOOP
    ...
    GET DIAGNOSTICS deleted_count = ROW_COUNT;
    IF deleted_count > 0 THEN
      RAISE NOTICE '  Deletadas % matrículas para usuário %', deleted_count, current_user_id;
    END IF;
  END LOOP;
  ...
  LOOP
    ...
    GET DIAGNOSTICS deleted_count = ROW_COUNT;
    IF deleted_count > 0 THEN
      RAISE NOTICE '  Deletado perfil para usuário %', current_user_id;
    END IF;
  END LOOP;
