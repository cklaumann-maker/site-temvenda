...
O Next.js pode mostrar erros de TypeScript ou módulos. Veja seção de troubleshooting abaixo.
...
**Solução**: O Next.js vai compilar automaticamente. Se persistir:
...
2. Criar organização/programa (via SQL ou interface)
